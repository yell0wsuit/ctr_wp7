	...
	internal class VideoDataManager
	{
		...
		public static void init()
		{
			if (VideoDataManager.videoDataMgr != null)
			{
				...
				VideoDataManager.videoDataMgr.initWith(text, (int)FrameworkTypes.CHOOSE3(0.0, 1.0, 2.0));
			}
		}
		...
		public static void clear()
		{
			if (VideoDataManager.videoDataMgr != null)
			{
				VideoDataManager.videoDataMgr.clear();
			}
		}
