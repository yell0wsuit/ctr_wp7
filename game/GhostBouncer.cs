...
namespace ctre_wp7.game
{
	...
	internal class GhostBouncer : Bouncer
	{
		...
		public override NSObject initWithPosXYWidthAndAngle(float px, float py, int w, double an)
		{
			...
			{
				this.backCloud2 = Image.Image_createWithResIDQuad(180, 2);
				float num = (float)Math.Sqrt(925.0);
				this.backCloud2.x = this.x + num * (float)Math.Cos((double)MathHelper.DEGREES_TO_RADIANS((float)(170.0 + an)));
				this.backCloud2.y = this.y + num * (float)Math.Sin((double)MathHelper.DEGREES_TO_RADIANS((float)(170.0 + an)));
				...
				timeline.addKeyFrame(KeyFrame.makePos((double)(this.backCloud2.x + 1f), (double)(this.backCloud2.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0.0));
				timeline.addKeyFrame(KeyFrame.makePos((double)(this.backCloud2.x - 0f), (double)(this.backCloud2.y - 0f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.3499999940395355));
				timeline.addKeyFrame(KeyFrame.makePos((double)(this.backCloud2.x - 1f), (double)(this.backCloud2.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.3499999940395355));
				timeline.addKeyFrame(KeyFrame.makePos((double)(this.backCloud2.x + 0f), (double)(this.backCloud2.y + 0f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.3499999940395355));
				timeline.addKeyFrame(KeyFrame.makePos((double)(this.backCloud2.x + 1f), (double)(this.backCloud2.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.3499999940395355));
				this.backCloud2.addTimelinewithID(timeline, 0);
				this.backCloud2.playTimeline(0);
				this.backCloud = Image.Image_createWithResIDQuad(180, 2);
				float num2 = (float)Math.Sqrt(925.0);
				this.backCloud.x = this.x + num2 * (float)Math.Cos((double)MathHelper.DEGREES_TO_RADIANS((float)(10.0 + an)));
				this.backCloud.y = this.y + num2 * (float)Math.Sin((double)MathHelper.DEGREES_TO_RADIANS((float)(10.0 + an)));
				...
				timeline2.addKeyFrame(KeyFrame.makePos((double)(this.backCloud.x + 1f), (double)(this.backCloud.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_IMMEDIATE, 0.0));
				timeline2.addKeyFrame(KeyFrame.makePos((double)(this.backCloud.x - 0f), (double)(this.backCloud.y - 0f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.38999998569488525));
				timeline2.addKeyFrame(KeyFrame.makePos((double)(this.backCloud.x - 1f), (double)(this.backCloud.y - 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.38999998569488525));
				timeline2.addKeyFrame(KeyFrame.makePos((double)(this.backCloud.x + 0f), (double)(this.backCloud.y + 0f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN, 0.38999998569488525));
				timeline2.addKeyFrame(KeyFrame.makePos((double)(this.backCloud.x + 1f), (double)(this.backCloud.y + 1f), KeyFrame.TransitionType.FRAME_TRANSITION_EASE_OUT, 0.38999998569488525));
		...
		public override void playTimeline(int t)
		{
			...
			if (t != 11 && base.getCurrentTimelineIndex() == 10 && this.getCurrentTimeline().state != Timeline.TimelineState.TIMELINE_STOPPED)
			{
